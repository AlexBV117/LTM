...
data_22 = get_data("2.2_Ramp_8.9K_to_8.4K.csv", (0, 238), 9.5e-4, [3.762, 36, -8.7], sigmoid)
data_23 = get_data("2.3_Ramp_8.4K_to_8.9K.csv", (0, 238), 9.5e-4, [3.76, 36, -8.65], sigmoid)
